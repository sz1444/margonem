(function() {
    ...
    styleSheet.innerText = `
        ...
        .hub-desc { font-size: 8px; font-weight: 300; line-height:1.2;  text-transform: none; color: #adadad; margin-top: 2px;}
        .hub-label {display: flex; flex-wrap: wrap; gap: 2px; color: #eee; font-size: 10px; font-weight: bold; letter-spacing: 0.5px; text-transform: uppercase; }
